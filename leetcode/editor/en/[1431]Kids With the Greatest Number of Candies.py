...
class Solution:
    def kidsWithCandies(self, candies: List[int], extraCandies: int) -> List[bool]:
        """
        Runtime:30 ms, faster than 98.06% of Python3 online submissions.
        Memory Usage:16.4 MB, less than 94.33% of Python3 online submissions.
        """
        max_candy = max(candies)
        result = [True if n_candy+extraCandies >= max_candy else False for n_candy in candies]
        return result
