...
#  
# 
#  Related Topics Array Hash Table String Dynamic Programming 👍 389 👎 13
...
class Solution:
    def maximumCostSubstring(self, s: str, chars: str, vals: List[int]) -> int:
        dict_cost = {ch: idx + 1 for idx, ch in enumerate(ascii_lowercase)}
        ...
        for ch in s:
            val = dict_cost[ch]
            curr_cost = max(val, curr_cost + val)
