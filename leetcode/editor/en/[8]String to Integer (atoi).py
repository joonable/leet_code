...
#  
# 
#  Related Topics String 👍 4006 👎 12441
...
class Solution:
    def myAtoi(self, s: str) -> int:
        """
        Success:
            Runtime:26 ms, faster than 99.78% of Python3 online submissions.
            Memory Usage:16.3 MB, less than 49.79% of Python3 online submissions.
        """
        s = s.lstrip()
