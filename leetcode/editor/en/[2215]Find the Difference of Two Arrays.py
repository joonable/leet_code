...
#  
# 
#  Related Topics Array Hash Table 👍 2216 👎 90
...
class Solution:
    def findDifference(self, nums1: List[int], nums2: List[int]) -> List[List[int]]:
        """
        Runtime:130 ms, faster than 96.77% of Python3 online submissions.
        Memory Usage:17 MB, less than 78.07% of Python3 online submissions.
        """
        dict_nums = {}
