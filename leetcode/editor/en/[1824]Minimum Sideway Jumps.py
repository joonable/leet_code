...
# ranging from 0 to 3) describes an obstacle on the lane obstacles[i] at point i. If 
# obstacles[i] == 0, there are no obstacles at point i. There will be at most one 
...
# there is not an obstacle on the lane at point i + 1. To avoid obstacles, the frog 
...
#  
# 
#  Related Topics Array Dynamic Programming Greedy 👍 1268 👎 51
